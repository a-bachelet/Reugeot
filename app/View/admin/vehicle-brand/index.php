    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary panel-table">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="panel-title" style="height: 30px; line-height: 30px;"><span class="glyphicon glyphicon-registration-mark"></span>&nbsp;&nbsp;&nbsp;Marques</h3>
                    </div>
                    <div class="col-md-4">
                        <a href="<?= WEB_ROOT . '/administration/vehicules-marques/ajouter' ?>" class="btn btn-success btn-sm pull-right">Ajouter</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col col-xs-8">
                        <ul class="pagination hidden-xs pull-right">
                            ...
                            <?php if ($params['viewedPage'] !== 1 && $params['viewedPage'] !== 2): ?>
                                <li><a href="<?= WEB_ROOT . '/administration/vehicules-marques?page=1' ?>">«</a></li>
                            <?php endif; ?>
                            <?php if ($params['viewedPage'] - 1 >= 1): ?>
                                <li><a href="<?= WEB_ROOT . '/administration/vehicules-marques?page=' . ($params['viewedPage'] - 2) ?>"><</a></li>
                                <li><a href="<?= WEB_ROOT . '/administration/vehicules-marques?page=' . ($params['viewedPage'] - 1) ?>"><?= $params['viewedPage'] - 1 ?></a></li>
                            <?php endif; ?>
                            ...
                            <?php if ($params['viewedPage'] !== $params['pageCount'] && $params['viewedPage'] !== $params['pageCount'] - 1): ?>
                                <li><a href="<?= WEB_ROOT . '/administration/vehicules-marques?page=' . $params['pageCount'] ?>">»</a></li>
                            <?php endif; ?>
                        ...
                        <ul class="pagination visible-xs pull-right">
                            <?php if($params['viewedPage'] !== 1): ?>
                                <li><a href="<?= WEB_ROOT . '/administration/vehicules-marques?page=' . ($params['viewedPage']-1) ?>">«</a></li>
                            <?php endif; ?>
